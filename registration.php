    ...
    <div class="box2">
      ...
      <form name="Registration" action="" method="post">
        ...
        <div class="login">
          ...
          <input class="btn btn-default" type="submit" name="submit" value="Sign Up" style="color: black; width: 70px;border-radius:20px;background-color: green; height: 30px"> </div>
      </form>
